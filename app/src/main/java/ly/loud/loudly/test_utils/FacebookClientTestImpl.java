...
public class FacebookClientTestImpl implements FacebookClient {
    ...
    @NonNull
    @Override
    public Call<Data<List<Post>>> loadPosts(
    ...
    @NonNull
    @Override
    public Call<Map<String, Post>> getInfo(
            @NonNull @Query("ids") String ids,
            @NonNull @Query("access_token") String accessToken
    ) {
        return null;
    }
    ...
    @NonNull
    @Override
    public Call<Data<List<Post>>> continueLoadPostsWithPagination(
    ...
    @NonNull
    @Override
    public Call<Data<List<FbComment>>> loadComments(
    ...
    @NonNull
    @Override
    public Call<Map<String, FbPerson>> getPersonsInfo(
            @NonNull @Query("ids") String ids,
            @NonNull @Query("access_token") String accessToken
    ) {
        return null;
    ...
    @NonNull
    @Override
    public Call<Data<List<FbPerson>>> getLikesOrShares(
            @NonNull @Path("id") String id,
    ...
    @Override
    public Call<Result> deleteElement(
            @NonNull @Path("id") String id,
            @NonNull @Query("access_token") String accessToken
    ) {
        return null;
    ...
    @NonNull
    @Override
    public Call<ElementId> uploadPhoto(
    ...
    @NonNull
    @Override
    public Call<Map<String, Picture>> getPictureInfos(
            @NonNull @Query("ids") String ids,
            @NonNull @Query("access_token") String accessToken
    ) {
        return null;
    ...
    @NonNull
    @Override
    public Call<ElementId> uploadPost(
